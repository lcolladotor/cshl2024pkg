# Getting help with `cshl2024pkg`

Thank you for using `cshl2024pkg`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/cshl2024pkg`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/cshl2024pkg),
...
[search issues and pull requests](https://github.com/lcolladotor/cshl2024pkg/issues)
